...
namespace ELTE.Sudoku.View
{
    public partial class GameForm : Form
    {
        ...
        private ISudokuDataAccess _dataAccess = null!; // adatelérés
        private SudokuGameModel _model = null!; // játékmodell
        ...
        private void MenuFileExit_Click(Object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Biztosan ki szeretne lépni?", "Game name", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                // ha igennel válaszol
                Close();
            }
